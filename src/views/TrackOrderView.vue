  ...
  <div class="track-order-view page-wrapper animate-fade-in">
    ...
    <header class="tracking-header">
      <div class="tracking-header-content">
        <h1 class="logo-text">{{ brand.brand_name }}</h1>
    ...
    <div v-else-if="errorMsg" class="empty-state animate-fade-in">
      ...
      <a :href="`https://wa.me/${brand.whatsapp_number || brand.support_phone?.replace(/\D/g, '')}`" target="_blank" class="btn btn-yellow whatsapp-btn">
